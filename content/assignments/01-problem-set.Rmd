...
<p style="text-align:center"><a target="_blank" href="/assignment/01-problem-set-pdf.pdf"><span class="btn btn-primary btn-lg"><i class="fas fa-file-pdf"></i> Download PDF</a></span> <a target="_blank" href="/assignment/00-preliminary-survey-answers.html"><span class="btn btn-primary btn-lg"><i class="fab fa-markdown"></i> Download Markdown</a></span> <a target="_blank" href="/assignment/00-preliminary-survey-answers.html"><span class="btn btn-primary btn-lg"><i class="fas fa-cloud"></i> View Project on R Studio Cloud</a></span></p>
