...
{{% alert note %}}
Please submit on Blackboard Assignments by the end of the day Tuesday November 23.
{{% /alert %}}

Please read the [instructions](/assignments/problem-sets) for completing homeworks.

<p style="text-align:center"><a target="_blank" href="/assignment/05-problem-set-pdf.pdf"><span class="btn btn-primary btn-lg"><i class="fas fa-file-pdf"></i> PDF</a></span> <a target="_blank" href="/assignment/05-problem-set.zip"><span class="btn btn-primary btn-lg"><i class="fas fa-file-archive"></i> R Project</a></span> <a target="_blank" href="https://rstudio.cloud/spaces/163934/project/3248158"><span class="btn btn-primary btn-lg"><i class="fas fa-cloud"></i> R Studio Cloud</a></span></p>

## Answers

<p style="text-align:center"><a target="_blank" href="/assignment/05-problem-set-answers.html"><span class="btn btn-primary btn-lg"><i class="fas fa-external-link-square-alt"></i> Answers (html)</a> <a target="_blank" href="/assignment/05-problem-set-answers-pdf.pdf"><span class="btn btn-primary btn-lg"><i class="fas fa-file-pdf"></i> Answers (PDF)</a> <a target="_blank" href="/assignment/05-problem-set-answers.zip"><span class="btn btn-primary btn-lg"><i class="fas fa-file-archive"></i> Answers (R Project)</a></p>
...
What we actually have are two different regression lines. Visualize this with a scatterplot between `infrate` $(Y)$ and `ph` $(X)$ `color`ed by `lead` [Hint: make sure `lead` is a `factor` variable].
