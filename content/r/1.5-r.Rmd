---
title: "1.5 — Optimize Your Workflow with Projects, Markdown, and Git — Practice"
draft: false
date: "2020-06-08"
...
<img src="../../images/workflowgitdownload.png" width=400">
...
Find my slides on the [class github page](https://github.com/ryansafner/metricsF21). Note there is a lot going on here, because this is a pretty full website. They are in the `static/slides` folder. Now if you are ever curious how I did something in my slides, you can see the source `.Rmd` files. Note my slides are written in [`Xaringan`](http://github.com/yihui/xaringan) (a special, `html`-based slides package). Note the slides are quite advanced - I use a lot of html and css formatting to make them pretty!

## Part 8

Now we are just exposing you to more `.Rmd` files. Look at the answer key for [1.4 R practice](/r/1.4-r) and download and open the <i class="fab fa-markdown"></i> `markdown` file. Take a look through it and see how it works, then when you are ready, click the `knit` button. It will make the `html` webpage (which you can open in any browser) that is identical to the answer key web page I made!

## Part 9

Look at the <i class="fab fa-markdown"></i> `markdown` file in this week's [homework assignment](/assignments/01-problem-set). If you want, you can complete your homework using that file.