...
<p style="text-align:center"><a target="_blank" href="/r/3.4-r.zip"><span class="btn btn-primary btn-lg"><i class="fas fa-file-archive"></i> R Project</a></span> <a target="_blank" href="https://rstudio.cloud/spaces/163934/project/2990242"><span class="btn btn-primary btn-lg"><i class="fas fa-cloud"></i> R Studio Cloud</a></span></p>
...
See the notation I used in [class](https://metricsF21.ryansafner.com/slides/3.4-slides.html#40).
