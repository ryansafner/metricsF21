...
.smallest[
- $\hat{\beta_2}$: Effect of .hi-turquoise[marriage] on wages for .hi-blue[men]
...
.smallest[
- $\hat{\beta_2}$: *Difference* in wages between .hi-blue[men] and .hi[women] who are .hi-orange[unmarried] 
