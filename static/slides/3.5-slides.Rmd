...
- So I need to control for school, effort (proxied by final grade), gender, covid, and (if I had data on it...) topic
...
&+ \alpha_i + \tau_t + u_{it}\\ \end{align*}$$
]

- A nonlinear (quadratic) model with panel data for country $i$ in time $t$