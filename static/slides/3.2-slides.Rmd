...
.center[
![:scale 90%](../images/causaltwitter.png)
]
...
.smallest[
- .hi-turquoise[“Correlation does not imply causation”]
  - this is exactly backwards!
  - this is just pointing out that .hi-purple[exogeneity is violated]
]
]
...
- .hi[“Correlation implies causation”]
...
- .hi[“Correlation plus exogeneity is causation.”]
]
]
...
- .hi-purple[Causation:]
  ...
  - .hi[Counterfactual thinking], unique to humans (vs. animals or computers)
  - Computers .ul[*cannot*] (yet) figure this out
...
.pull-left[
.center[
![:scale 70%](../images/ladderofcausation.png)
]
]

.pull-right[
.center[
![:scale 70%](../images/bookofwhy.jpg)
]
]
...
- Simultaneous .hi[“credibility revolution”] in econometrics (c.1990s—2000s)

- Use clever research designs to approximate .hi-purple[natural experiments]
...
.pull-right[
.smallest[
- Tells you some .hi-turquoise[testable implications] of your model

- These are independencies or .hi-turquoise[conditional independencies]:
...
- .hi-green[Example]: look at the last one listed: 

.center[`job_connections` `\\(\perp\\)` `year` `\\(\vert\\)` `educ`]
...
.smallest[
.bg-washed-green.b--dark-green.ba.bw2.br3.shadow-5.ph4.mt5[
.green[**Example**]: Are you less likely to get the flu if you are hit by a bus?
...
- .ul[**In the NBA**], players’ height has no relationship to points scored
