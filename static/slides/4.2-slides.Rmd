...
### [Generalizing DND Models](#72)
### [Example II: "The" Card-Kreuger Minimum Wage Study](#80)
...
$$\widehat{Y_{it}}=\alpha_i+\theta_t+\beta_3 (\text{Treated}_i \times \text{After}_{t})+\nu_{it}$$
...
.smallest[
$$\widehat{InCollege_{it}}=0.091 \, (\text{Georgia}_i \times \text{After}_{it})+\alpha_i+\theta_t$$
...
--
.smallest[
$$\widehat{InCollege_{it}}=\alpha_i+\theta_t+0.023 \, (\text{Georgia}_i \times \text{After}_{it})-0.094 \text{Black}_{it}-0.302 \text{LowIncome}_{it}$$
