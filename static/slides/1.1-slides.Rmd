...
- `r fa("slack", fill ="#5E81AC")` Slack channel `#c-306-metrics`
...
- See the [resources page](http://metricsF21.classes.ryansafner.com/resources) for tips for success and more helpful resources
]
]
...
.center[
![:scale 80%](../images/metrics_website_f21.png)
...
.center[
![:scale 100%](../images/metrics_flowchart_blankbg.png)
]
