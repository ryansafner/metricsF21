...
<!--
Note one weird thing about PDFs (due to LaTeX) is that using latex math requires you to use "aligned" instead of "align*" in my aligned equations...also figure sizes are pretty fussy...
-->
...
$$\begin{aligned}\bar{x}&=\frac{1}{n} \sum^n_{i=1} x_i\\
...
$$\begin{aligned}E(X)&=\sum^n_{i=1} p_ix_i\\
&=0.2(0)+(0.4)1+(0.4)2\\
&=0+0.4+0.8\\
&=1.2\\
\end{aligned}$$
...
$$\begin{aligned}P(400  \leq  S  \leq 600)&=P\big(\frac{400-500}{100} \leq \frac{S - 500}{100} \leq \frac{600-500}{100}\big)\\
...
$$\begin{aligned}P(300  \leq  S  \leq 700)&=P\big(\frac{300-500}{100} \leq \frac{S - 500}{100} \leq \frac{700-500}{100}\big)\\
